...
class CrustsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create crust" do
    assert_difference('Crust.count') do
      post crusts_url, params: { crust: { crust_name: @crust.crust_name, crust_price: @crust.crust_price } }
    end
  ...
  test "should update crust" do
    patch crust_url(@crust), params: { crust: { crust_name: @crust.crust_name, crust_price: @crust.crust_price } }
